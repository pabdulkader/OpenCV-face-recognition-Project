...
def detect_face(img):
    ...
    face_cascade=cv2.CascadeClassifier(r'C:\Users\LENOVO\Desktop\project validation\Opencv\haarcascade_frontalface_default.xml')
...
print('prepare data.....')
faces,labels=prepare_training_data(r'C:\Users\LENOVO\Desktop\project validation\Opencv\DB')
print('data prepared')
...
imgg=input("image")
# test_img1=cv2.imread(r'C:\Users\LENOVO\Desktop\project validation\Opencv\DB\messi\02.jpg')
